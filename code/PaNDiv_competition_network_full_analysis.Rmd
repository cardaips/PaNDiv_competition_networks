...
<br>
<br>
To avoid long running time, several Rdata images were also saved in the "result" folder, and can be loaded in the corresponding parts of the script.
<br>
<br>
...
#simplifying dates (all are august covers)
dat2020$datum<-2020

#2020 table
datot20<-matrix(data=0, nrow=336, ncol=26, byrow = F, dimnames = NULL)
colnames(datot20)<-c("year","plot","Am","Ao","As","Be","Cb","Cj","Dc","Dg","Fr","Ga","Hl","Hp","Hs","Lp","Pg","Pm","Pt","Ra","Sp","To","bg", "legume","herb","grass")
datot20<-as.data.frame(datot20)
dat2020<-as.data.frame(dat2020)
dat2020<-dat2020[order(dat2020$plot),]

#loop for filling 2020 table
i<-1
j<-1
k<-1
datot20$plot[i]<-i
...
datapred<-slarichpred(m2,allrich_data,n)
datavpred <-slarichvpred(m2, allrich_data,n)

diagrichpred<-ggplot(aes(x=SLA, y=fit, colour=Treatment), data=datapred)+
  ylim(c(-2,2))+
...
diagrichvpred<-ggplot(aes(x=SLAv, y=fit, colour=Treatment), data=datavpred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
datapred<-slarichpred(m3,allrich_data,n)
datavpred <-slarichvpred(m3, allrich_data,n)

asymrichpred<-ggplot(aes(x=SLA, y=fit, colour=Treatment), data=datapred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
asymrichvpred<-ggplot(aes(x=SLAv, y=fit, colour=Treatment), data=datavpred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
datapred<-slarichpred(m4,allrich_data,n)
datavpred <-slarichvpred(m4, allrich_data,n)

skewrichpred<-ggplot(aes(x=SLA, y=fit, colour=Treatment), data=datapred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
skewrichvpred<-ggplot(aes(x=SLAv, y=fit, colour=Treatment), data=datavpred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
datapred<-slarichpred(m5,allrich_data,n)
datavpred <-slarichvpred(m5, allrich_data,n)

ginirichpred<-ggplot(aes(x=SLA, y=fit, colour=Treatment), data=datapred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
ginirichvpred<-ggplot(aes(x=SLAv, y=fit, colour=Treatment), data=datavpred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
datapred<-slarichpred(m1,allrich_data,n)
datavpred <-slarichvpred(m1, allrich_data,n)

modurichpred<-ggplot(aes(x=SLA, y=fit, colour=Treatment), data=datapred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
modurichvpred<-ggplot(aes(x=SLAv, y=fit, colour=Treatment), data=datavpred)+
  ylim(c(-2,2))+
  facet_grid(~network.size)+
  geom_smooth(method = lm)+
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.1)+
...
```{r, plot of supp fig. 4 and 5, fig.width = 14, fig.height = 8, fig.align ='center' }
