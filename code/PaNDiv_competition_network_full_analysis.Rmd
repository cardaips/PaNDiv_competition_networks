...
```{r, supplementary figure 2 and 3 interaction histograms, fig.width = 8, fig.height = 8, fig.align ='center'}
...
We can also plot the two seasons separately to obtain figs. S6 and S7:
```{r, plot of supp fig. 6 and 7, fig.width = 8, fig.height = 14, fig.align ='center', echo = FALSE }
...
```
<br>
From the results of these multimembership model, we can plot the Supplementary figure 8, which present the impact of treatment and SLA on mixed communities of different size across June and August 2020.
<br>
```{r, plot of supp fig. 8, fig.width = 14, fig.height = 16, fig.align ='center', echo=FALSE}
...
```
<br>
And the Supplementary figure 9, which present the impact of treatment and SLA variance on mixed communities of different size across June and August 2020.
<br>
```{r, plot of supp fig. 9, fig.width = 14, fig.height = 16, fig.align ='center', echo=FALSE}
...
```{r, plot supplementary figure 4, fig.align ='center', fig.width=13, fig.height=8, echo = FALSE}
...
```{r, plot supplementary figure 5, fig.align ='center', fig.width=7, fig.height=6, echo = FALSE}
...
```{r,plot supplementary figure 11, fig.align ='center', fig.height=10, fig.width=10, echo = FALSE}
