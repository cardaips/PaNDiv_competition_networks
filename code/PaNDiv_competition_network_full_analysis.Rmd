...
```{r, plot of fig. 3, fig.width = 17, fig.height = 11, fig.align ='center' }
...
```{r, supplementary fig 2 slow growing network plot, fig.width = 8, fig.height=12, echo=FALSE}
...
```{r, supplementary fig 2 fast growing network plot, fig.width = 8, fig.height=12, echo=FALSE}
...
```
<br>
From the results of these multimembership model, we can plot the Supplementary figure 5, which present the impact of treatment and SLA on mixed communities of different size across June and August 2020.
<br>
...
```
<br>
And the Supplementary figure 6, which present the impact of treatment and SLA variance on mixed communities of different size across June and August 2020.
<br>
...
```{r,plot supplementary figure 7, fig.align ='center', fig.height=10, fig.width=10, echo = FALSE}
...
```{r, plot supplementary figure 9, fig.align ='center', fig.width=7, fig.height=6, echo = FALSE}
...
```{r, plot supplementary figure 10, fig.align ='center', fig.width=8, fig.height=8, echo = FALSE}
