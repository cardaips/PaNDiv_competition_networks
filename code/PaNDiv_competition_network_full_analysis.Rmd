...
```{r, plot of supp fig. 4 and 5, fig.width = 14, fig.height = 16, fig.align ='center', echo=FALSE}
...
modelsummary(modelist, statistic = "p.value", fmt = fmt_statistic(estimate = 2, p.value = 3))
