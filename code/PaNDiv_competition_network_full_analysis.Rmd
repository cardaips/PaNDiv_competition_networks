...
## d. PaNDiv SLA shift with treatment {-}

Lastly, we used PaNDiv cover and SLA data in order to check the plots shift in SLA with nitrogen treatment (monocultures were excluded). A negative Delta_SLA means that communities are shifting toward lower values of SLA, and that they become more slow growing.
